...
@tepthon.ar_cmd(pattern="الصيد")
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس ابن سعد : 
        ...
        try:
            ch = await tepthon(
                functions.channels.CreateChannelRequest(
                    ...
                    about="This channel to hunt username by - @oj5555 ",
                )
            )
...
async def _(event):
    ...
    isclaim.clear()
    isclaim.append("off")
    await tepthon.send_message(event.chat_id, "**- تم الانتهاء من التثبيت بنجاح**")


@tepthon.ar_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@tepthon.ar_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
